...
// Device descriptor (per-interface device)
const tusb_desc_device_t descriptor_device = {
  .bLength = sizeof(tusb_desc_device_t),
  .bDescriptorType = TUSB_DESC_DEVICE,
  .bcdUSB = 0x0200,
  // Use per-interface class (0) to avoid IAD / MISC warnings on Windows
  .bDeviceClass = 0x00,
...
const char* string_descriptor[] = {
  ...
  "NW-Lab",            // 1: Manufacturer
  "EasyShortcutKey GW",// 2: Product
  "ESPKGW-0001",       // 3: Serial
